...
<div id="content">
  <div id="content-header">
      <div id="breadcrumb"> <a href="<?php echo site_url();?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="<?php echo site_url("aplikasi_haki");?>" class="tip-bottom">Aplikasi Haki</a> <a href="<?php echo site_url("aplikasi_haki/hak_cipta");?>" class="tip-bottom">Hak Cipta</a><a href="" class="current">Detail Hak Cipta</a> </div>
      <h1>Detail Pengajuan Hak Cipta</h1>
  </div>
          ...
          <div class="widget-content"> 
            ...
            <table>
              <tr>
                ...
                <td>
                   : <?php echo $detail_pengajuan_hak_cipta[0]['nama'];?>
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                   : <?php echo $detail_pengajuan_hak_cipta[0]['alamat'];?>
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                   : <?php echo $detail_pengajuan_hak_cipta[0]['telpon'];?>
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                   : <?php echo $detail_pengajuan_hak_cipta[0]['email'];?>
                </td>
              </tr>
            </table>
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content"> 
            ...
            <table rules="row" class="table-data">
              <tr>
                <td width="60%">
                  <b>Tanggal Permohonan</b>
                </td>
                <td>
                   : <?php echo $detail_pengajuan_hak_cipta[0]['tanggal_permohonan'];?>
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                   : <?php echo $detail_pengajuan_hak_cipta[0]['tanggal_penerimaan'];?>
                </td>
              </tr>
               <tr>
                <td>
                ...
                <td>
                   : <?php echo $detail_pengajuan_hak_cipta[0]['no_permohonan'];?>
                </td>
              </tr>
               ...
               <tr>
                ...
                <td>
                   : <?php echo $detail_pengajuan_hak_cipta[0]['nama_pencipta'];?>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                   : <?php echo $detail_pengajuan_hak_cipta[0]['alamat_pencipta'];?>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                   : <?php echo $detail_pengajuan_hak_cipta[0]['email_pencipta'];?>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                   : <?php echo $detail_pengajuan_hak_cipta[0]['telpon_pencipta'];?>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                   : <?php echo $detail_pengajuan_hak_cipta[0]['fax_pencipta'];?>
                </td>
              </tr>
               ...
               <tr>
                ...
                <td>
                   : <?php echo $detail_pengajuan_hak_cipta[0]['nama_pemegang_hak_cipta'];?>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                   : <?php echo $detail_pengajuan_hak_cipta[0]['alamat_pemegang_hak_cipta'];?>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                   : <?php echo $detail_pengajuan_hak_cipta[0]['email_pemegang_hak_cipta'];?>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                   : <?php echo $detail_pengajuan_hak_cipta[0]['telpon_pemegang_hak_cipta'];?>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                   : <?php echo $detail_pengajuan_hak_cipta[0]['fax_pemegang_hak_cipta'];?>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                   : <?php echo $detail_pengajuan_hak_cipta[0]['judul_ciptaan'];?>
                </td>
              </tr>

              <tr>
                <td>
                  <b>Tanggal Diumumkan</b>
                </td>
                <td>
                   : <?php echo $detail_pengajuan_hak_cipta[0]['tanggal_diumumkan'];?>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                   : <?php echo $detail_pengajuan_hak_cipta[0]['uraian_ciptaan'];?>
                </td>
              </tr>
               ...
               <tr>
                  ...
                  <td>
                     ...
                     <table class="table-data">
                       <tr>
                         <td id="isi-status">
                           : <?php  if($detail_pengajuan_hak_cipta[0]['status']=="1")
                                      echo "Diajukan";
                                    else if($detail_pengajuan_hak_cipta[0]['status']=="2")
                                      echo "Kena surat";
                                    else if($detail_pengajuan_hak_cipta[0]['status']=="3")
                                      echo "Jawab surat";
                                    else if($detail_pengajuan_hak_cipta[0]['status']=="4")
                                      echo "Diterima";
                                    else if($detail_pengajuan_hak_cipta[0]['status']=="5")
                                      echo "Ditolak";
             ...
             <input type="hidden" id="id-pengajuan" name="id-pengajuan" value="<?php echo $detail_pengajuan_hak_cipta[0]['id_permohonan'];?>">
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="widget-content"> 
           ...
           ?>
            ...
            <form id="berkas-lampiran" method="post" enctype="multipart/form-data" action="<?php echo site_url("crud/save_lampiran");?>">
               <input type="hidden" id="id-pengajuan" name="id-pengajuan" value="<?php echo $detail_pengajuan_hak_cipta[0]['id_permohonan'];?>">
               <input type="hidden" id="id-tipe" name="id-tipe" value="2">
  ...
  function SaveStatus(){
       $("#btn-open-change").html('<button class="btn btn-success" onclick="OpenChangeStatus()">Change Status</button>');
        ...
        if(status!="placeholder"){
            ...
            $.ajax({
            url: '<?php echo site_url("crud/change_status_hak_cipta");?>',
            type: 'post',
            data: { id: id,
                    status : status
